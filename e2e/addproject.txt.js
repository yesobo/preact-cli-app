...
var sikuli_count = 0; var chrome_id = 1;
...
if (chrome.exists(x('//*[@id="'+locator+'"]'))) return x('//*[@id="'+locator+'"]');
if (chrome.exists(x('//*[contains(@id,"'+locator+'")]'))) return x('//*[contains(@id,"'+locator+'")]');
if (chrome.exists(x('//*[@name="'+locator+'"]'))) return x('//*[@name="'+locator+'"]');
if (chrome.exists(x('//*[contains(@name,"'+locator+'")]'))) return x('//*[contains(@name,"'+locator+'")]');
if (chrome.exists(x('//*[@class="'+locator+'"]'))) return x('//*[@class="'+locator+'"]');
if (chrome.exists(x('//*[contains(@class,"'+locator+'")]'))) return x('//*[contains(@class,"'+locator+'")]');
if (chrome.exists(x('//*[@title="'+locator+'"]'))) return x('//*[@title="'+locator+'"]');
if (chrome.exists(x('//*[contains(@title,"'+locator+'")]'))) return x('//*[contains(@title,"'+locator+'")]');
if (chrome.exists(x('//*[@aria-label="'+locator+'"]'))) return x('//*[@aria-label="'+locator+'"]');
if (chrome.exists(x('//*[contains(@aria-label,"'+locator+'")]'))) return x('//*[contains(@aria-label,"'+locator+'")]');
if (chrome.exists(x('//*[text()="'+locator+'"]'))) return x('//*[text()="'+locator+'"]');
if (chrome.exists(x('//*[contains(text(),"'+locator+'")]'))) return x('//*[contains(text(),"'+locator+'")]');
if (chrome.exists(x('//*[@href="'+locator+'"]'))) return x('//*[@href="'+locator+'"]');
if (chrome.exists(x('//*[contains(@href,"'+locator+'")]'))) return x('//*[contains(@href,"'+locator+'")]');
return x('/html');}
...
// first check for exact match then check for containing string
if (chrome.exists(x('//*[@id="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@id,"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[@name="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@name,"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[@class="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@class,"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[@title="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@title,"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[@aria-label="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@aria-label,"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[text()="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(text(),"'+locator+'")]'))) return true;
if (chrome.exists(x('//*[@href="'+locator+'"]'))) return true;
if (chrome.exists(x('//*[contains(@href,"'+locator+'")]'))) return true;
return false;}
...
{if (param2.indexOf('[enter]') == -1) return "chrome.sendKeys(tx('" + param1 + "'),'" + param2 + "')";
...
return "chrome.sendKeys(tx('" + param1 + "'),'" + param2 + "',{keepFocus: true});";}}
...
if (params == '') return "this.echo('ERROR - target missing for " + raw_intent + "')";
else if (check_tx(params)) return "this.echo('" + raw_intent + "' + ' - ' + chrome.fetchText(tx('" + params + "')).trim())";else return "this.echo('ERROR - cannot find " + params + "')";}
...
else return "dom_result = chrome.evaluate(function() {" + params + "})";}
...
var flow_path = 'C:/Users/A168943/dev/aad-versioning/real-aad-projects/aad-apps-catalog/e2e';
...
{techo('enter search-box as github');
...
casper.waitFor(function check() {return check_tx('search-box');},
function then() {this.echo('print search-box' + ' - ' + chrome.fetchText(tx('search-box')).trim());},
function timeout() {this.echo('ERROR - cannot find search-box').exit();});}});

casper.then(function() {
// use tap (or click) step to click on a webpage element
// below step clicks the search button
{techo('click search-button');
...
{techo('snap page to results.png');
chrome.capture('C:/Users/A168943/dev/aad-versioning/real-aad-projects/aad-apps-catalog/e2e/results.png');}
{techo('snap logo to logo.png');
casper.waitFor(function check() {return check_tx('logo');},
function then() {chrome.captureSelector('C:/Users/A168943/dev/aad-versioning/real-aad-projects/aad-apps-catalog/e2e/logo.png',tx('logo'));},
function timeout() {this.echo('ERROR - cannot find logo').exit();});}});
...
{techo('enter search_form_input_homepage as The search engine that doesn\'t track you.');
